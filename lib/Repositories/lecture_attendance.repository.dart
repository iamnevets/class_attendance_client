...
class LectureAttendanceRepository {
  static Position? userCurrentLocation;

  Future<ReturnObject> joinLecture(LectureAttendance lectureAttendance) async {
    var response = await LectureAttendanceController().create(lectureAttendance);
  ...
  Future<Position> determinePosition() async {
    ...
    userCurrentLocation = await Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high);
